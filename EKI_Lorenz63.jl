...
function run_Lorenz_ensemble(params_i, Tobs=10, Tspinup=30, Δt=0.01)
...
function EKI_Run(t_mean, t_cov)
    ...
    for i in 1:N_iter
        ...
        g_ens = run_Lorenz_ensemble(params_i)
