...
contour(X, Y, Z, Array(LinRange(minimum(Z)+0.01*maximum(Z), maximum(Z), 20)), alpha=0.5)
xlabel(L"c_s")
ylabel(L"k_s")
# plot MCMC results 
everymarker = 1
scatter(us[n_burn_in:everymarker:end, 1], us[n_burn_in:everymarker:end, 2], s = 1)
tight_layout()
PyPlot.savefig("UKI-MCMC-3-a.png")
...
# plot MCMC results 
everymarker = 1
scatter(us[n_burn_in:everymarker:end, 2], us[n_burn_in:everymarker:end, 3], s = 1)
tight_layout()
PyPlot.savefig("UKI-MCMC-3-b.png")
...
# plot MCMC results 
everymarker = 1
scatter(us[n_burn_in:everymarker:end, 3], us[n_burn_in:everymarker:end, 1], s = 1)
tight_layout()
PyPlot.savefig("UKI-MCMC-3-c.png")
