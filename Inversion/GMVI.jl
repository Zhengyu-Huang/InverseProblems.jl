...
GMVIObj Constructor 
"""
function GMVIObj(# initial condition
                x0_w::Array{FT, 1},
                x0_mean::Array{FT, 2},
...
"""
function update_ensemble!(gmgd::GMVIObj{FT, IT}, func::Function, dt_max::FT) where {FT<:AbstractFloat, IT<:Int}
...
function GMVI_Run(
    ...
    gmgdobj = GMVIObj(# initial condition
